...
import Results2025 from "../../components/Results/Results2025";
...
const Results2025Page: NextPage<Props> = ({ statistic }) => {
  ...
  return <Results2025 statistic={statistic} />;
};
...
export default Results2025Page;
