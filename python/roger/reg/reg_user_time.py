...
async def user_time_20(callback_query: types.CallbackQuery, state: dispatcher.FSMContext):
    user_time = 20
...
async def user_time_21(callback_query: types.CallbackQuery, state: dispatcher.FSMContext):
    user_time = 21
    await delete_keyboard(callback_query.from_user.id, callback_query.message.message_id)
...
async def user_time_22(callback_query: types.CallbackQuery, state: dispatcher.FSMContext):
    user_time = 22
    await delete_keyboard(callback_query.from_user.id, callback_query.message.message_id)
...
async def user_time_23(callback_query: types.CallbackQuery, state: dispatcher.FSMContext):
    user_time = 23
    await delete_keyboard(callback_query.from_user.id, callback_query.message.message_id)
